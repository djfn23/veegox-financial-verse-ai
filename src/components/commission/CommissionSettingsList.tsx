            ...
            <TableRow key={setting.id}>
              ...
              <TableCell>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>Modifier le pourcentage de commission</p>
                  </TooltipContent>
                </Tooltip>
              </TableCell>
              <TableCell>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>Montant minimum auquel la commission s'applique</p>
                  </TooltipContent>
                </Tooltip>
              </TableCell>
              <TableCell>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>Montant maximum auquel la commission s'applique (vide = illimité)</p>
                  </TooltipContent>
                </Tooltip>
              </TableCell>
              <TableCell>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>{setting.is_active ? "Désactiver" : "Activer"} ce paramètre de commission</p>
                  </TooltipContent>
                </Tooltip>
              </TableCell>
            </TableRow>
