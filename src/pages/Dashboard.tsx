          ...
          <div className="bg-yellow-900/20 border border-yellow-700/50 rounded-lg p-4 mb-8 flex items-center">
            ...
            <div>
              <p className="text-yellow-300">
                Cette interface de tableau de bord est actuellement en démonstration. La connexion de wallet et les fonctionnalités web3 seront activées lors du lancement de la plateforme.
              </p>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="md:col-span-2">
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm font-mono">0x...n/a</span>
                  </div>
